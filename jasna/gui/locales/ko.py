...
KO = {
        ...
        "tip_vr_mode": "좌우 분할 VR180 처리 방식을 설정합니다.\n\n자동은 높이가 1080픽셀을 넘는 정확한 2:1 프레임, 신뢰할 수 있는 스튜디오 파일명 토큰 또는 호환 공간 메타데이터가 있을 때 활성화됩니다. SBS는 양쪽 눈을 각각 감지·복원하며, 감지된 각 모자이크 영역을 직선형 패치로 펼쳐 2D 복원 모델로 처리한 뒤 복원된 패치를 원래 투영으로 되돌립니다. SBS + 어안도 동일한 처리이며 알려진 어안 VR 스튜디오에서 자동 선택됩니다.\n\n구간 편집기는 왼쪽 눈만 표시하지만 스캔과 내보내기는 양쪽 눈을 처리합니다.\n기본값: 자동",
