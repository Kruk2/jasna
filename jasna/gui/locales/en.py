...
EN = {
        ...
        "tip_vr_mode": "Controls side-by-side VR180 processing.\n\nAuto enables it for exact 2:1 frames taller than 1080 pixels, trusted studio filename tokens, or compatible spatial metadata. SBS detects and restores both eyes separately, flattening each detected mosaic region to a rectilinear patch for the 2D restoration model and reprojecting the restored patch back. SBS + fisheye runs the same restoration and is auto-selected for known fisheye VR studios.\n\nThe segment editor displays the left eye while scans and exports process both eyes.\nDefault: Auto",
