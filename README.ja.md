...
- サイドバイサイド VR180 動画を左右の目ごとに処理し、各モザイク領域の復元投影（raw／魚眼／グノモニック）をスタジオごとに振り分けます。区間エディターでは各方式をプレビューできます。
...
- **[VR180 動画](docs/ja/vr180.md)** — Jasna がサイドバイサイド VR をどう扱うか、スタジオ別の投影振り分け。
...
交互にして実行した 3 回の中央値です。括弧内の比率は Lada を基準にしています。
Lada では 8K を実行していないため、その行だけは v0.8.1 が基準です。SONE の
各クリップは 6,056 フレーム（3:22）、8K VR クリップは 900 フレーム（15 秒）です。

| 入力 | Lada 0.11.0 v2 | v0.4.1 | v0.5.0 | v0.6.2 | v0.7.2 | v0.8.1 | **v0.9.0 (4a171c9)** |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 720p H.264 8-bit | 01:47 (基準) | 01:35 (1.1倍高速) | 00:45 (2.4倍高速) | 00:45 (2.4倍高速) | 00:47 (2.3倍高速) | 00:49 (2.2倍高速) | **00:34 (3.1倍高速)** |
| 1080p H.264 8-bit | 02:02 (基準) | 01:46 (1.2倍高速) | 00:47 (2.6倍高速) | 00:46 (2.7倍高速) | 00:44 (2.8倍高速) | 00:50 (2.5倍高速) | **00:39 (3.2倍高速)** |
| 1080p HEVC 10-bit | 02:06 (基準) | 01:48 (1.2倍高速) | 00:48 (2.6倍高速) | 00:47 (2.7倍高速) | 00:46 (2.7倍高速) | 00:50 (2.5倍高速) | **00:36 (3.5倍高速)** |
| 2160p H.264 8-bit | 04:56 (基準) | 03:23 (1.5倍高速) | 01:22 (3.6倍高速) | 01:16 (3.9倍高速) | 01:16 (3.9倍高速) | 01:30 (3.3倍高速) | **01:15 (3.9倍高速)** |
...
| 入力 | Lada | v0.4.1 | v0.5.0 | v0.6.2 | v0.7.2 | v0.8.1 | **v0.9.0** |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
