...
交替目标顺序运行三次的中位数。括号内的倍数以 Lada 为基准；由于 Lada 未运行
8K，该行改用 v0.8.1 作为基准。每个 SONE 片段有 6,056 帧（3:22），8K VR
片段有 900 帧（15 秒）。

| 输入 | Lada 0.11.0 v2 | v0.4.1 | v0.5.0 | v0.6.2 | v0.7.2 | v0.8.1 | **v0.9.0 (4a171c9)** |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 720p H.264 8-bit | 01:47 (基准) | 01:35 (快 1.1 倍) | 00:45 (快 2.4 倍) | 00:45 (快 2.4 倍) | 00:47 (快 2.3 倍) | 00:49 (快 2.2 倍) | **00:34 (快 3.1 倍)** |
| 1080p H.264 8-bit | 02:02 (基准) | 01:46 (快 1.2 倍) | 00:47 (快 2.6 倍) | 00:46 (快 2.7 倍) | 00:44 (快 2.8 倍) | 00:50 (快 2.5 倍) | **00:39 (快 3.2 倍)** |
| 1080p HEVC 10-bit | 02:06 (基准) | 01:48 (快 1.2 倍) | 00:48 (快 2.6 倍) | 00:47 (快 2.7 倍) | 00:46 (快 2.7 倍) | 00:50 (快 2.5 倍) | **00:36 (快 3.5 倍)** |
| 2160p H.264 8-bit | 04:56 (基准) | 03:23 (快 1.5 倍) | 01:22 (快 3.6 倍) | 01:16 (快 3.9 倍) | 01:16 (快 3.9 倍) | 01:30 (快 3.3 倍) | **01:15 (快 3.9 倍)** |
...
GPU 显存为基准测试目标的中位数/峰值（GiB）；`—` 表示未运行。

| 输入 | Lada | v0.4.1 | v0.5.0 | v0.6.2 | v0.7.2 | v0.8.1 | **v0.9.0** |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
