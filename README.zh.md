...
预设。冻结版和 Lada 的计时为舍弃预热运行后的一次实测；v0.9.0 的计时为预热后
交替目标顺序运行三次的中位数。v0.9.1 同样是预热后三次运行的中位数，目前只
重新测量了 H.264 输入。括号内的倍数以 Lada 为基准；由于 Lada 未运行
8K，该行改用 v0.8.1 作为基准。每个 SONE 片段有 6,056 帧（3:22），8K VR
片段有 900 帧（15 秒）。

| 输入 | Lada 0.11.0 v2 | v0.4.1 | v0.5.0 | v0.6.2 | v0.7.2 | v0.8.1 | v0.9.0 (4a171c9) | **v0.9.1 (18add8a)** |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 720p H.264 8-bit | 01:47 (基准) | 01:35 (快 1.1 倍) | 00:45 (快 2.4 倍) | 00:45 (快 2.4 倍) | 00:47 (快 2.3 倍) | 00:49 (快 2.2 倍) | 00:34 (快 3.1 倍) | **00:32 (快 3.4 倍)** |
| 1080p H.264 8-bit | 02:02 (基准) | 01:46 (快 1.2 倍) | 00:47 (快 2.6 倍) | 00:46 (快 2.7 倍) | 00:44 (快 2.8 倍) | 00:50 (快 2.5 倍) | 00:39 (快 3.2 倍) | **00:34 (快 3.6 倍)** |
| 1080p HEVC 10-bit | 02:06 (基准) | 01:48 (快 1.2 倍) | 00:48 (快 2.6 倍) | 00:47 (快 2.7 倍) | 00:46 (快 2.7 倍) | 00:50 (快 2.5 倍) | 00:36 (快 3.5 倍) | — |
| 2160p H.264 8-bit | 04:56 (基准) | 03:23 (快 1.5 倍) | 01:22 (快 3.6 倍) | 01:16 (快 3.9 倍) | 01:16 (快 3.9 倍) | 01:30 (快 3.3 倍) | 01:15 (快 3.9 倍) | **01:03 (快 4.7 倍)** |
| 2160p HEVC 10-bit | 05:11 (基准) | 03:24 (快 1.5 倍) | 01:31 (快 3.4 倍) | 01:24 (快 3.7 倍) | 01:20 (快 3.9 倍) | 01:34 (快 3.3 倍) | 01:19 (快 3.9 倍) | — |
| 2160p AV1 10-bit | 05:21 (基准) | 03:22 (快 1.6 倍) | 01:30 (快 3.6 倍) | 01:20 (快 4.0 倍) | 01:20 (快 4.0 倍) | — | 01:05 (快 5.0 倍) | — |
| 8K VR HEVC 8-bit 60 fps | — | — | — | — | — | 00:45 (8K 基准) | 00:34 (快 1.3 倍) | — |

GPU 显存为基准测试目标的中位数/峰值（GiB）；`—` 表示未运行。括号内的倍数以
中位数与 v0.4.1 比较；v0.4.1 未运行的 8K 行改用 v0.8.1 作为基准。Lada 不参与
该比较：它的显存占用低于任何 Jasna 版本。

| 输入 | Lada | v0.4.1 | v0.5.0 | v0.6.2 | v0.7.2 | v0.8.1 | v0.9.0 | **v0.9.1** |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 720p H.264 8-bit | 1.8/3.1 | 17.6/19.9 (基准) | 8.6/9.0 (少 2.0 倍) | 8.8/9.1 (少 2.0 倍) | 8.8/9.2 (少 2.0 倍) | 8.6/9.2 (少 2.0 倍) | 8.6/9.1 (少 2.0 倍) | **4.2/4.6 (少 4.2 倍)** |
| 1080p H.264 8-bit | 2.0/3.3 | 18.9/21.4 (基准) | 9.5/10.2 (少 2.0 倍) | 9.7/10.3 (少 1.9 倍) | 9.7/10.5 (少 1.9 倍) | 9.6/10.1 (少 2.0 倍) | 9.3/10.1 (少 2.0 倍) | **4.8/5.6 (少 3.9 倍)** |
| 1080p HEVC 10-bit | 2.0/3.5 | 19.1/21.5 (基准) | 9.9/10.6 (少 1.9 倍) | 10.0/10.7 (少 1.9 倍) | 10.0/10.7 (少 1.9 倍) | 9.6/10.3 (少 2.0 倍) | 9.4/10.3 (少 2.0 倍) | — |
| 2160p H.264 8-bit | 2.6/4.1 | 26.0/30.5 (基准) | 12.9/15.0 (少 2.0 倍) | 12.4/15.3 (少 2.1 倍) | 12.5/15.2 (少 2.1 倍) | 11.8/15.0 (少 2.2 倍) | 11.4/15.4 (少 2.3 倍) | **7.2/10.9 (少 3.6 倍)** |
| 2160p HEVC 10-bit | 2.6/4.0 | 26.6/30.5 (基准) | 14.0/15.9 (少 1.9 倍) | 13.8/16.1 (少 1.9 倍) | 13.5/16.2 (少 2.0 倍) | 12.1/15.4 (少 2.2 倍) | 12.0/15.9 (少 2.2 倍) | — |
| 2160p AV1 10-bit | 2.6/3.8 | 26.6/30.1 (基准) | 13.8/16.2 (少 1.9 倍) | 13.5/16.2 (少 2.0 倍) | 13.5/16.2 (少 2.0 倍) | — | 11.8/15.8 (少 2.3 倍) | — |
| 8K VR HEVC 8-bit 60 fps | — | — | — | — | — | 18.5/18.9 (基准) | 17.1/18.3 (少 1.1 倍) | — |
